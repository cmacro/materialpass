...
pub fn generate_bindings() -> Builder<tauri::Wry> {
    use crate::commands::{notifications, preferences, procurement, quick_pane, recovery};
    ...
    Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        procurement::get_procurement_items,
        procurement::create_procurement_item,
        procurement::update_procurement_item,
        procurement::delete_procurement_item,
    ])
}
